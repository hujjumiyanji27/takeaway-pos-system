...
class _NewOrderScreenState extends State<NewOrderScreen> {
  ...
  void loadProductsFromDatabase() async {
  ...
  double get total =>
      orderItems.fold(0.0, (sum, item) => sum + item['price'] * item['quantity']);

  double get vat => total * 0.20;
        ...
        children: [
          ...
          Expanded(
            ...
            child: filteredProducts.isEmpty
                ? Center(child: Text('No products in "$selectedCategory"'))
                : GridView.builder(
                    padding: EdgeInsets.all(10),
                    itemCount: filteredProducts.length,
                    gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
